import {randomText} from "./visual.js";
...
export class Particle{
    ...
    draw(ctx, t){
        this.rgb += (this.savedRgb - this.rgb) * colorSpeed;
        ...
        const red = ((this.rgb >> 16) & 0xFF) | 0; //bitwise AND and bitwise OR
